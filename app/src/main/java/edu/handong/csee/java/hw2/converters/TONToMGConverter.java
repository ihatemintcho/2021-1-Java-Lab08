...
/**
 * this class implements Convertible to accommodate TON input and changing it to MG
 */
public class TONToMGConverter
{
    /**
    ...
    /**
     * this method converts ton to mg
     */
    public void convert()
    {
        measurement = measurement * 1000000000;
    }
